...
export class TimerCircleComponent extends React.Component<TimerCircleProps, TimeCircleState> {
    VELOCITY_MS: number = 1000;
    currentIntervall;
    ...
    render() {
        return <TouchableOpacity onPress={this.toggleTimer}><View style={styles.surface}>
            {<Text style={styles.circleText}>{this.state.currentDisplayString}</Text>}
    ...
    private updateTime() {
        ...
        currentSeconds++;
        let tempSeconds = currentSeconds;
