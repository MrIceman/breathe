...
export class AuthResponseMapper implements ResponseMapper<AuthEntity, Response> {
    ...
    mapEntity(entity: AuthEntity): AuthResponse {
        return new AuthResponse(entity.jwtToken, entity.jwtToken !== null,
            entity.jwtToken === undefined ? this.mapErrorCode(entity.error) : undefined);
    }
}